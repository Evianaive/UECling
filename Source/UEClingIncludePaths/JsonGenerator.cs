...
namespace Plugins.UCling.UEClingIncludePathsPlugin;

[UnrealHeaderTool]
class GeneratedCodeModifier
{
	[UhtExporter(Name = "UEClingIncludePathsPlugin", Description = "Modify the thunk function of UFUNCTION", Options = UhtExporterOptions.Default, ModuleName="UCling")]
